...
--end,
  ...
  test = function()
   ...
   -- [MS-NLMP] 4.2.3.2.1
    test:call('[4.2.3.2.1] ComputeResponse', i.ComputeResponse, {i}, {true, "\xaa\xaa\xaa\xaa\xaa\xaa\xaa\xaa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\x75\x37\xf8\x03\xae\x36\x71\x28\xca\x45\x82\x04\xbd\xe7\xca\xf8\x1e\x97\xed\x26\x83\x26\x72\x32"})

    -- [MS-NLMP] 4.2.3.3
    test:call('[4.2.3.3]   parse_ntlm_challenge', i.parse_ntlm_challenge, {i, ""}, { true })
